...
# from March, 1998 through March 2013. The files sbuxPrices.csv is 
# assumed to be in the directory G:\\Dropbox\\Lecture Notes\\Financial Econometrics\\HW1_Return
...
# system
#CHANGE TO YOUR DIRECTORY: go to the top menu and click session, set working directory and choose directory. You can choose where your csv and R files are located. 

setwd('/Users/noahkawasaki/Desktop/ECON 147')
...
# extract prices between 2006-07-03 and 2009-02-02, which roughly contains the period of financial crisis
sbux.df[101:132,]
...
# lty=1 sets the line type (1 for solid line, 2 for dashed line, ...)
